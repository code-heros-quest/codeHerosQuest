...
let shimmeringVial = new Loot('Shimmering Vial', ['Warrior', 'Wizard', 'Assassin', 'Hunter'], 0, 0);
...
let improvedArmor = new Loot('Improved Armor', ['Warrior', 'Wizard', 'Assassin', 'Hunter'], 1, 1);
...
let tinTownBandages = new Loot('Tin Town Bandages', ['Warrior', 'Wizard', 'Assassin', 'Hunter'], 2, 0);
...
let blessedWater = new Loot('Blessed Water', ['Warrior', 'Wizard', 'Assassin', 'Hunter'], 1, 1);
